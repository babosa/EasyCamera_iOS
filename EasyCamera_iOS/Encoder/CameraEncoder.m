...
- (void)initCameraWithOutputSize:(CGSize)size
{
    ...
    /*
       激活授权码，
     */
    if (EasyPusher_Activate("6A36334A742F2B32734B79416B68745A707552476350564659584E355548567A614756794931634D56714459384F424859585A7062695A4359574A76633246414D6A41784E6B566863336C4559584A33615735555A5746745A57467A65513D3D") == 0) {
        if (_delegate) {
...
-(void) captureOutput:(AVCaptureOutput*)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection*)connection
{
    ...
    if(connection == self.videoConnection)
    {
        ...
        _screenShotImage = [UIImage imageWithCGImage:newImage scale:1.0 orientation:UIImageOrientationUp];
        
        CGContextRelease(newContext);
        CGColorSpaceRelease(colorSpace);
//         NSData* imageData = UIImageJPEGRepresentation(image, 1.0);
//        _screenShotImage =  [UIImage imageWithData:imageData];;
